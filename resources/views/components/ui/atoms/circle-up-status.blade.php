<svg aria-hidden="true" {{ $attributes->merge(['class' => '']) }} focusable="false" data-icon="circle-check" data-prefix="fad" class="" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <g class="fa-group">
    <path
      fill="#A7F3D0"
