...
<svg {{ $attributes->merge(['class' => '']) }}
  ...
  <g class="fa-group">
    ...
    <path class="fa-primary"
          fill="currentColor"
          d="M176 322.9V160c0-8.75-7.25-16-16-16s-16 7.25-16 16v162.9c-18.62 6.625-32 24.25-32 45.13c0 26.5 21.5 48 48 48s48-21.5 48-48C208 347.1 194.6 329.5 176 322.9z"></path>
  </g>
</svg>
<!-- End::SVG -->
